...
try {
    ...
    $expected = [ordered]@{card_clock=94; signature_cards=49; card_preview=38; hex_playability=19; party_hud_stats=10; card_art=38; backpack=23; release_blockers=71; combat_guide=8; demo_polish=12}
