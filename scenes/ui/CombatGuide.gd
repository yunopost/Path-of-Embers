...
const RULES := "Your three characters share HP and a deck. Take your time: the clock advances when you act, not while you read.\n\nPLAY CARDS\nDrag an attack onto an enemy. Drag other cards upward to play them. Check the card's resource cost and time cost: advancing time brings enemy timers closer to their next action.\n\nBREATHE · SPACE\nGain 1 energy and advance time by 1 tick. Energy has no upper cap.\n\nFOCUS · F\nDraw 2 cards and advance time by 1 tick. Breathe and Focus each start a new cycle for effects that refer to cycles. If your hand is full, additional drawn cards go to the discard pile.\n\nPARTY ABILITIES\nUse the button below a character's portrait. Hover to see its cost. If it needs a target, click an enemy; Escape cancels targeting.\n\nSTAY ALIVE\nBlock remains until damage consumes it. Read enemy intentions before spending time. Complete your chosen quests to open the final boss path.\n\nYou can reopen these rules with HOW TO PLAY during combat."
